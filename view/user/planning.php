...
<div class="row">
    <nav class="col-lg-2 flex-column navbar-light sidebar">
        <ul class="navbar-nav">
            ...
            <li class="nav-link-dropdown">
                <a href="#edtSubmenu" data-bs-toggle="collapse" aria-expanded="false" class="nav-link dropdown-toggle">Cours</a>
                <div class="indent">
                    <ul class="collapse list-unstyled" id="edtSubmenu">
                        <?php foreach (PROMO_ARR as $v) : ?>
                            <?php foreach (SUJET_ARR as $val) : ?>
                                <li>
                                    <a class="nav-link" href="#"><?= $v . " " . $val ?></a>
                                </li>
                            <?php endforeach; ?>
